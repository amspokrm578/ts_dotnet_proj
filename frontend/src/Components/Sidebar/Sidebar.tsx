...
// Type assertion helper to fix React 19 type compatibility with react-icons
const HomeIcon = FaHome as React.ComponentType<React.SVGProps<SVGSVGElement>>;
            ...
            <div className="flex-col min-h-full px-0 flex flex-wrap items-center justify-between w-full mx-auto overflow-y-auto overflow-x-hidden">
              ...
              <div className="flex bg-white flex-col items-stretch opacity-100 relative mt-4 overflow-y-auto overflow-x-hidden h-auto z-40 items-center flex-1 rounded w-full">
                ...
                <div className="md:flex-col md:min-w-full flex flex-col list-none">
                  ...
                  <Link to="company-profile" className="flx md:min-w-full text-blueGray-500 text-medium uppercase font-bold block pt--1 pb-4 no-underline">
                    <HomeIcon />
                    <h5 className="ml-3">Company Profile</h5>
                  </Link>
                  <Link to="income-statement" className="flx md:min-w-full text-blueGray-500 text-medium uppercase font-bold block pt--1 pb-4 no-underline">
                    <HomeIcon />
